    ...
    if message.channel.id not in channels_with_image_access:
        ...
        for k in message.author.roles:
            if k.id in roles_allowed_to_send_images:
                ...
                break
        if to_pass==True:
            for i in ["https://media.discordapp.net/attachments","https://cdn.discordapp.com/attachments", "https://imgur.com", "https://i.imgur.com", "https://images-ext-1.discordapp.net/external", "https://www.reddit.com/", "https://www.youtube.com/", "https://bit.ly/"]:
